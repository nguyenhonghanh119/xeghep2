...
public class PassengerService : IPassengerService
{
    ...
    public async Task<(bool ok, string message)> ConfirmVnPayPaymentAsync(string vnpTxnRef, string vnpResponseCode, long vnpAmount)
    {
        ...
        if (vnpResponseCode != "00")
        {
            ...
            // Thanh toán thất bại: hoàn lại ghế đã trừ lúc tạo booking, tránh mất ghế oan cho khách.
            // Chỉ hoàn 1 lần — nếu VNPay gọi lại (return + IPN) cho cùng giao dịch, booking đã ở trạng thái
            // rejected thì bỏ qua, không cộng ghế trùng lặp.
